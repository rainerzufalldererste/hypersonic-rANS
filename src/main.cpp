...
constexpr size_t MaxEncoderCount = 48; // if someone needs more than 48, simply increase this.
constexpr size_t MaxDecoderCount = 48; // if someone needs more than 48, simply increase this.
