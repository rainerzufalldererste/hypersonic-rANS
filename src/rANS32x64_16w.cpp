...
#endif
size_t rANS32x64_xmmShfl_16w_decode_avx2_varA(const uint8_t *pInData, const size_t inLength, uint8_t *pOutData, const size_t outCapacity)
{
...
__attribute__((target("avx2")))
#endif
size_t rANS32x64_xmmShfl_16w_decode_avx2_varB(const uint8_t *pInData, const size_t inLength, uint8_t *pOutData, const size_t outCapacity)
{
  if (inLength <= sizeof(uint64_t) * 2)
    return 0;
...
__attribute__((target("avx2")))
#endif
size_t rANS32x64_xmmShfl_16w_decode_avx2_varC(const uint8_t *pInData, const size_t inLength, uint8_t *pOutData, const size_t outCapacity)
{
  if (inLength <= sizeof(uint64_t) * 2)
    return 0;
...
size_t rANS32x64_xmmShfl_16w_decode_avx2_varA_15(const uint8_t *pInData, const size_t inLength, uint8_t *pOutData, const size_t outCapacity) { return rANS32x64_xmmShfl_16w_decode_avx2_varA<15>(pInData, inLength, pOutData, outCapacity); }
size_t rANS32x64_xmmShfl_16w_decode_avx2_varB_15(const uint8_t *pInData, const size_t inLength, uint8_t *pOutData, const size_t outCapacity) { return rANS32x64_xmmShfl_16w_decode_avx2_varB<15>(pInData, inLength, pOutData, outCapacity); }
...
size_t rANS32x64_xmmShfl_16w_decode_avx2_varA_14(const uint8_t *pInData, const size_t inLength, uint8_t *pOutData, const size_t outCapacity) { return rANS32x64_xmmShfl_16w_decode_avx2_varA<14>(pInData, inLength, pOutData, outCapacity); }
size_t rANS32x64_xmmShfl_16w_decode_avx2_varB_14(const uint8_t *pInData, const size_t inLength, uint8_t *pOutData, const size_t outCapacity) { return rANS32x64_xmmShfl_16w_decode_avx2_varB<14>(pInData, inLength, pOutData, outCapacity); }
...
size_t rANS32x64_xmmShfl_16w_decode_avx2_varA_13(const uint8_t *pInData, const size_t inLength, uint8_t *pOutData, const size_t outCapacity) { return rANS32x64_xmmShfl_16w_decode_avx2_varA<13>(pInData, inLength, pOutData, outCapacity); }
size_t rANS32x64_xmmShfl_16w_decode_avx2_varB_13(const uint8_t *pInData, const size_t inLength, uint8_t *pOutData, const size_t outCapacity) { return rANS32x64_xmmShfl_16w_decode_avx2_varB<13>(pInData, inLength, pOutData, outCapacity); }
...
size_t rANS32x64_xmmShfl_16w_decode_avx2_varA_12(const uint8_t *pInData, const size_t inLength, uint8_t *pOutData, const size_t outCapacity) { return rANS32x64_xmmShfl_16w_decode_avx2_varA<12>(pInData, inLength, pOutData, outCapacity); }
size_t rANS32x64_xmmShfl_16w_decode_avx2_varB_12(const uint8_t *pInData, const size_t inLength, uint8_t *pOutData, const size_t outCapacity) { return rANS32x64_xmmShfl_16w_decode_avx2_varB<12>(pInData, inLength, pOutData, outCapacity); }
size_t rANS32x64_xmmShfl_16w_decode_avx2_varC_12(const uint8_t *pInData, const size_t inLength, uint8_t *pOutData, const size_t outCapacity) { return rANS32x64_xmmShfl_16w_decode_avx2_varC<12>(pInData, inLength, pOutData, outCapacity); }
...
size_t rANS32x64_xmmShfl_16w_decode_avx2_varA_11(const uint8_t *pInData, const size_t inLength, uint8_t *pOutData, const size_t outCapacity) { return rANS32x64_xmmShfl_16w_decode_avx2_varA<11>(pInData, inLength, pOutData, outCapacity); }
size_t rANS32x64_xmmShfl_16w_decode_avx2_varB_11(const uint8_t *pInData, const size_t inLength, uint8_t *pOutData, const size_t outCapacity) { return rANS32x64_xmmShfl_16w_decode_avx2_varB<11>(pInData, inLength, pOutData, outCapacity); }
size_t rANS32x64_xmmShfl_16w_decode_avx2_varC_11(const uint8_t *pInData, const size_t inLength, uint8_t *pOutData, const size_t outCapacity) { return rANS32x64_xmmShfl_16w_decode_avx2_varC<11>(pInData, inLength, pOutData, outCapacity); }
...
size_t rANS32x64_xmmShfl_16w_decode_avx2_varA_10(const uint8_t *pInData, const size_t inLength, uint8_t *pOutData, const size_t outCapacity) { return rANS32x64_xmmShfl_16w_decode_avx2_varA<10>(pInData, inLength, pOutData, outCapacity); }
size_t rANS32x64_xmmShfl_16w_decode_avx2_varB_10(const uint8_t *pInData, const size_t inLength, uint8_t *pOutData, const size_t outCapacity) { return rANS32x64_xmmShfl_16w_decode_avx2_varB<10>(pInData, inLength, pOutData, outCapacity); }
size_t rANS32x64_xmmShfl_16w_decode_avx2_varC_10(const uint8_t *pInData, const size_t inLength, uint8_t *pOutData, const size_t outCapacity) { return rANS32x64_xmmShfl_16w_decode_avx2_varC<10>(pInData, inLength, pOutData, outCapacity); }
...
__attribute__((target("avx2")))
#endif
size_t rANS32x64_ymmPerm_16w_decode_avx2_varA(const uint8_t *pInData, const size_t inLength, uint8_t *pOutData, const size_t outCapacity)
{
  if (inLength <= sizeof(uint64_t) * 2)
    return 0;
...
__attribute__((target("avx2")))
#endif
size_t rANS32x64_ymmPerm_16w_decode_avx2_varB(const uint8_t *pInData, const size_t inLength, uint8_t *pOutData, const size_t outCapacity)
{
  if (inLength <= sizeof(uint64_t) * 2)
    return 0;
...
__attribute__((target("avx2")))
#endif
size_t rANS32x64_ymmPerm_16w_decode_avx2_varC(const uint8_t *pInData, const size_t inLength, uint8_t *pOutData, const size_t outCapacity)
{
  if (inLength <= sizeof(uint64_t) * 2)
    return 0;
...
size_t rANS32x64_ymmPerm_16w_decode_avx2_varA_15(const uint8_t *pInData, const size_t inLength, uint8_t *pOutData, const size_t outCapacity) { return rANS32x64_ymmPerm_16w_decode_avx2_varA<15>(pInData, inLength, pOutData, outCapacity); }
size_t rANS32x64_ymmPerm_16w_decode_avx2_varB_15(const uint8_t *pInData, const size_t inLength, uint8_t *pOutData, const size_t outCapacity) { return rANS32x64_ymmPerm_16w_decode_avx2_varB<15>(pInData, inLength, pOutData, outCapacity); }

size_t rANS32x64_ymmPerm_16w_decode_avx2_varA_14(const uint8_t *pInData, const size_t inLength, uint8_t *pOutData, const size_t outCapacity) { return rANS32x64_ymmPerm_16w_decode_avx2_varA<14>(pInData, inLength, pOutData, outCapacity); }
size_t rANS32x64_ymmPerm_16w_decode_avx2_varB_14(const uint8_t *pInData, const size_t inLength, uint8_t *pOutData, const size_t outCapacity) { return rANS32x64_ymmPerm_16w_decode_avx2_varB<14>(pInData, inLength, pOutData, outCapacity); }

size_t rANS32x64_ymmPerm_16w_decode_avx2_varA_13(const uint8_t *pInData, const size_t inLength, uint8_t *pOutData, const size_t outCapacity) { return rANS32x64_ymmPerm_16w_decode_avx2_varA<13>(pInData, inLength, pOutData, outCapacity); }
size_t rANS32x64_ymmPerm_16w_decode_avx2_varB_13(const uint8_t *pInData, const size_t inLength, uint8_t *pOutData, const size_t outCapacity) { return rANS32x64_ymmPerm_16w_decode_avx2_varB<13>(pInData, inLength, pOutData, outCapacity); }

size_t rANS32x64_ymmPerm_16w_decode_avx2_varA_12(const uint8_t *pInData, const size_t inLength, uint8_t *pOutData, const size_t outCapacity) { return rANS32x64_ymmPerm_16w_decode_avx2_varA<12>(pInData, inLength, pOutData, outCapacity); }
size_t rANS32x64_ymmPerm_16w_decode_avx2_varB_12(const uint8_t *pInData, const size_t inLength, uint8_t *pOutData, const size_t outCapacity) { return rANS32x64_ymmPerm_16w_decode_avx2_varB<12>(pInData, inLength, pOutData, outCapacity); }
size_t rANS32x64_ymmPerm_16w_decode_avx2_varC_12(const uint8_t *pInData, const size_t inLength, uint8_t *pOutData, const size_t outCapacity) { return rANS32x64_ymmPerm_16w_decode_avx2_varC<12>(pInData, inLength, pOutData, outCapacity); }

size_t rANS32x64_ymmPerm_16w_decode_avx2_varA_11(const uint8_t *pInData, const size_t inLength, uint8_t *pOutData, const size_t outCapacity) { return rANS32x64_ymmPerm_16w_decode_avx2_varA<11>(pInData, inLength, pOutData, outCapacity); }
size_t rANS32x64_ymmPerm_16w_decode_avx2_varB_11(const uint8_t *pInData, const size_t inLength, uint8_t *pOutData, const size_t outCapacity) { return rANS32x64_ymmPerm_16w_decode_avx2_varB<11>(pInData, inLength, pOutData, outCapacity); }
size_t rANS32x64_ymmPerm_16w_decode_avx2_varC_11(const uint8_t *pInData, const size_t inLength, uint8_t *pOutData, const size_t outCapacity) { return rANS32x64_ymmPerm_16w_decode_avx2_varC<11>(pInData, inLength, pOutData, outCapacity); }

size_t rANS32x64_ymmPerm_16w_decode_avx2_varA_10(const uint8_t *pInData, const size_t inLength, uint8_t *pOutData, const size_t outCapacity) { return rANS32x64_ymmPerm_16w_decode_avx2_varA<10>(pInData, inLength, pOutData, outCapacity); }
size_t rANS32x64_ymmPerm_16w_decode_avx2_varB_10(const uint8_t *pInData, const size_t inLength, uint8_t *pOutData, const size_t outCapacity) { return rANS32x64_ymmPerm_16w_decode_avx2_varB<10>(pInData, inLength, pOutData, outCapacity); }
size_t rANS32x64_ymmPerm_16w_decode_avx2_varC_10(const uint8_t *pInData, const size_t inLength, uint8_t *pOutData, const size_t outCapacity) { return rANS32x64_ymmPerm_16w_decode_avx2_varC<10>(pInData, inLength, pOutData, outCapacity); }
